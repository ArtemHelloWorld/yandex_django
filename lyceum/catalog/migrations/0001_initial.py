    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight', models.PositiveSmallIntegerField(default=150, help_text='Укажите массу', verbose_name='масса')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Укажите название. Максимум 150 символов', max_length=150, verbose_name='название')),
                ('is_published', models.BooleanField(default=True, help_text='Уберите галочку, если хотите скрыть запись', verbose_name='опубликовано')),
                ('text', tinymce.models.HTMLField(help_text='Придумайте описание. Текст должен включать слова превосходно или роскошно', validators=[catalog.validators.ValidateMustContain('превосходно', 'роскошно')], verbose_name='описание')),
                ('is_on_main', models.BooleanField(default=False, help_text='Поставьте галочку, если хотите отобразить товар на главной странице', verbose_name='добавить на главную страницу')),
                ('date_created', models.DateField(auto_now_add=True, verbose_name='дата создания')),
                ('date_updated', models.DateField(auto_now=True, verbose_name='дата последнего изменения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image_main', models.ImageField(upload_to='item/main/%Y/%m/%d')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image_gallery', models.ImageField(upload_to='item/gallery/%Y/%m/%d')),
        ...
        migrations.AddField(
            model_name='item',
            name='image',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='catalog.itemimagemain', verbose_name='главное фото'),
        ),
        migrations.AddField(
            model_name='item',
            name='tags',
            field=models.ManyToManyField(help_text='Выберите тег или создайте новый', to='catalog.Tag', verbose_name='теги'),
        ),
    ]

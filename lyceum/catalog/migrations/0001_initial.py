...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(validators=[catalog.validators.ValidateMustContain("превосходно", "роскошно")], help_text='Укажите название. Максимум 150 символов', max_length=150, verbose_name='название')),
                ('is_published', models.BooleanField(default=True, help_text='Уберите галочку, если хотите скрыть запись', verbose_name='опубликовано')),
                ('text', models.TextField(help_text='Придумайте описание. Текст должен включать слова превосходно или роскошно', verbose_name='описание')),

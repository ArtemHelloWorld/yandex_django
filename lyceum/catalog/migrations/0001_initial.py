# Generated by Django 3.2.16 on 2023-02-19 20:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight', models.IntegerField(default=100, help_text='Укажите массу', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(32767)], verbose_name='масса')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Укажите название. Максимум 150 символов', max_length=150, verbose_name='название')),
                ('is_published', models.BooleanField(default=True, help_text='Уберите галочку, если хотите скрыть запись', verbose_name='опубликовано')),
                ('text', models.TextField(help_text='Придумайте описание. Текст должен включать слова превосходно или роскошно', validators=[catalog.validators.exist_adverbs_validator], verbose_name='описание')),
